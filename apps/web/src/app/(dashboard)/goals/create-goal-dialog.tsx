...
export function CreateGoalDialog() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (currentAmount < 0) {
      setErrors({ currentAmount: 'Valor inicial não pode ser negativo' })
      setIsLoading(false)
      return
    }
    ...
    try {
      ...
      setErrors({ general: 'Erro ao criar meta. Tente novamente.' })
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-gray-500">Quanto você já tem guardado para esta meta?</p>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-gray-500">Quando você quer alcançar esta meta?</p>
          </div>
