        ...
        <CardContent className="relative p-2.5 sm:p-5">
          <div className="flex items-center justify-between gap-1">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-sm sm:text-2xl font-bold mt-0.5 sm:mt-1 truncate">{formatCurrency(totalBalance)}</p>
              <p className="text-[9px] sm:text-xs text-emerald-100/80 mt-0.5 sm:mt-1">
                {accountsCount} {accountsCount === 1 ? 'conta' : 'contas'}
              </p>
            </div>
            <div className="flex h-8 w-8 sm:h-12 sm:w-12 items-center justify-center rounded-lg sm:rounded-2xl bg-white/20 backdrop-blur-sm flex-shrink-0">
      ...
      <Card className="group hover:shadow-lg hover:shadow-emerald-500/5 transition-all duration-300">
        <CardContent className="p-2.5 sm:p-5">
          <div className="flex items-center justify-between gap-1">
            ...
            <div className="flex h-8 w-8 sm:h-12 sm:w-12 items-center justify-center rounded-lg sm:rounded-2xl bg-emerald-100 dark:bg-emerald-500/20 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
      ...
      <Card className="group hover:shadow-lg hover:shadow-red-500/5 transition-all duration-300">
        <CardContent className="p-2.5 sm:p-5">
          <div className="flex items-center justify-between gap-1">
            ...
            <div className="flex h-8 w-8 sm:h-12 sm:w-12 items-center justify-center rounded-lg sm:rounded-2xl bg-red-100 dark:bg-red-500/20 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
