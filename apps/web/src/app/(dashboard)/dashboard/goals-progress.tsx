      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-6 text-center">
            ...
            <p className="text-xs text-muted-foreground/70">Crie metas para economizar</p>
          </div>
        </CardContent>
      </Card>
    )
        ...
        <div className="space-y-3">
          ...
          {completedGoals.length > 0 && (
            <div className="flex items-center gap-2 text-sm text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg px-3 py-2">
              ...
              <span>{completedGoals.length} meta(s) alcancada(s)!</span>
            </div>
          )}
          ...
          {activeGoals.length > 0 && currentGoal && (
            <div className="relative">
              ...
              <div
                className={cn(
                  'rounded-xl border border-border p-4 pr-8 transition-all duration-300',
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <CategoryIcon icon={currentGoal.icon || 'lucide:target'} className="h-5 w-5" />
                    </div>
                    <span className="font-medium text-foreground">{currentGoal.name}</span>
                  </div>
                  <span className="text-sm font-bold" style={{ color: currentGoal.color || '#10B981' }}>
